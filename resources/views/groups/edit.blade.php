...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('groups.update',$group) }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('put')
                        ...
                        <div class="card ">
                            ...
                            <div class="card-header card-header-primary">
                                ...
                                <h4 class="card-title">{{ __('Edit Group') }}</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('group_id') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('group_id') ? ' is-invalid' : '' }}" name="group_id" id="input-group_id" type="text" placeholder="{{ __('Group ID') }}" value="{{ old('group_id',$group->group_id) }}" required="true" aria-required="true"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('group_title') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('group_title') ? ' is-invalid' : '' }}" name="group_title" id="input-title" type="text" placeholder="{{ __('Group title') }}" value="{{ old('group_title',$group->group_title) }}" required="true" aria-required="true"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('group_language') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('group_language') ? ' is-invalid' : '' }}" name="group_language" id="input-language" type="text" placeholder="{{ __('Group language') }}" value="{{ old('group_language',$group->group_language) }}" required />
...
{{--                                        <div class="form-group{{ $errors->has('group_admin') ? ' has-danger' : '' }}">--}}
                                            <input class="form-control{{ $errors->has('admin') ? ' is-invalid' : '' }}" input type="text" name="group_admin" id="input-admin" placeholder="{{ __('Admin') }}" value="{{ old('group_admin',auth()->user()->user_id) }}" hidden>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('token') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('token') ? ' is-invalid' : '' }}" input type="text" name="token" id="input-token" placeholder="{{ __('Bot token') }}" value="{{ old('token',$group->token) }}" required />
                                            @if ($errors->has('token'))
