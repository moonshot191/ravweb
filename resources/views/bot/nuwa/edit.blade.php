@extends('layouts.app', ['activePage' => 'nuwas-management', 'titlePage' => __('Nuwas Management')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" enctype="multipart/form-data" action="{{ route('nuwas.update',$nuwa) }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('put')

                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">{{ __('Edit nuwas Question') }}</h4>
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <a href="{{ route('nuwas.index') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('answer') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('answer') ? ' is-invalid' : '' }}" onkeyup="shuffle()" name="answer" id="input-ans" type="text" placeholder="{{ __('Answer') }}" value="{{ old('answer',$nuwa->answer) }}" required="true" aria-required="true"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('level') ? ' has-danger' : '' }}">
                                            ...
                                            {!! Form::select('level', array(1 => 'Elementary', 2 => 'Intermediate',3=>'Advanced'), $nuwa->level,['class' => 'form-control']); !!}
                            ...
                            <div class="card-footer ml-auto mr-auto">
                                <button type="submit" class="btn btn-primary">{{ __('Update nuwas') }}</button>
                            </div>
                        </div>
                    </form>
