@extends('layouts.app', ['activePage' => 'nuwa-management', 'titlePage' => __('Nuwa Management')])
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title ">{{ $nuwa->total() }} {{str_plural('Question',$nuwa->count())}}</h4>
                            <p class="card-category"> {{ __('Here you can manage Nuwa questions') }}</p>
                        </div>
                        <div class="card-body">
                            @if (session('status'))
                                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 text-right">
                                    @can('add_nuwas')
                                        <button  class="btn btn-warning btn-sm validate_all" data-url="{{ route('nuwaval') }}"><i class="material-icons">thumb_up</i>Validate</button>
                                        <button  class="btn btn-danger btn-sm delete_all" data-url="{{ route('nuwadel') }}"><i class="material-icons">delete</i>Delete</button>
                                        <a href="{{ route('nuwas.create') }}" class="btn btn-sm btn-info">{{ __('Upload questions') }}</a>
                                        <a href="{{ route('nuwaexport') }}" class="btn btn-sm btn-success">{{ __('Export to CSV') }}</a>
...
{{--                                                </td>--}}
                                                <td class="td-actions text-right">
                                                    ...
                                                    <form action="{{ route('nuwas.destroy', $group) }}" method="post">
                                                        @csrf
                                                        @method('delete')
                                                        @can('edit_nuwas')
                                                            <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('nuwas.edit', $group) }}" data-original-title="" title="Edit">
                                                                <i class="material-icons">edit</i>
                                                                <div class="ripple-container"></div>
                                                            </a>
                                                        @endcan
                                                        @can('delete_nuwas')
                                                            <button type="button" class="btn btn-danger btn-link" data-toggle="tooltip"  onclick="confirm('{{ __("Are you sure you want to delete this group?") }}') ? this.parentElement.submit() : ''">
                                                                <i class="material-icons">close</i>
                                                                <div class="ripple-container"></div>
                                                            </button>
                                                        @endcan
...
{{--                                                        @method('post')--}}
                                    ...
                                    @else
                                        <td>
                                            <p>No nuwa created at the moment</p>
                                        </td>
                                    @endif
