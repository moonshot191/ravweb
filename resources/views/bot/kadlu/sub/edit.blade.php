...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('kadluqs.update',$kadluq) }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('put')

                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">{{ __('Edit Kadlu Associate Question') }}</h4>
                                <p class="card-category"></p>
                            </div>
                            <div class="card-body ">
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <a href="{{ route('kadluqs.index') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" id="input-title" type="text" placeholder="{{ __('Main question') }}" value="{{ old('title',$kadluq->kadlu->title) }}" disabled/>
                                            @if ($errors->has('title'))
                                        ...
                                        <div class="col-sm-7">
                                            <div
                                                ...
                                                <input
                                                    ...
                                                    value="{{ old('question',$kadluq->question) }}"
                                        ...
                                        <div class="col-sm-7">
                                            <div
                                                ...
                                                <input
                                                    ...
                                                    value="{{ old('answer_a',$kadluq->answer_a) }}"
                                                    required="true" aria-required="true"/>
                                        ...
                                        <div class="col-sm-7">
                                            <div
                                                ...
                                                <input
                                                    ...
                                                    value="{{ old('answer_b',$kadluq->answer_b) }}"
                                                    required="true" aria-required="true"/>
                                        ...
                                        <div class="col-sm-7">
                                            <div
                                                ...
                                                <input
                                                    ...
                                                    value="{{ old('answer_c',$kadluq->answer_c) }}"
                                                    required="true" aria-required="true"/>
                                        ...
                                        <div class="col-sm-7">
                                            <div
                                                ...
                                                <input
                                                    ...
                                                    value="{{ old('answer_d',$kadluq->answer_d) }}"
                                                    required="true" aria-required="true"/>
                                ...
                                <input type="text" name="kadlu_id" value=" {{$kadluq->kadlu->id}}" hidden>
