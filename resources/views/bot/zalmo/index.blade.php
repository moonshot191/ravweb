@extends('layouts.app', ['activePage' => 'zalmo-management', 'titlePage' => __('Zalmo Management')])
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 text-right">
                                    @can('add_zalmos')
                                        <button  class="btn btn-warning btn-sm validate_all" data-url="{{ route('zalmoval') }}"><i class="material-icons">thumb_up</i>Validate</button>
                                        <button  class="btn btn-danger btn-sm delete_all" data-url="{{ route('zalmodel') }}"><i class="material-icons">delete</i>Delete</button>
...
{{--                                                        @method('post')--}}
                                    ...
                                    @else
                                        <td>
                                            <p>No zalmo created at the moment</p>
                                        </td>
                                    @endif
