                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title ">{{ $odin->total() }} {{str_plural('Question',$odin->count())}}</h4>
                            <p class="card-category"> {{ __('Here you can manage odin questions') }}</p>
                        </div>
                        <div class="card-body">
                            @if (session('status'))
                                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 text-right">
                                    @can('add_odins')
                                        <button  class="btn btn-warning btn-sm validate_all" data-url="{{ route('odinval') }}"><i class="material-icons">thumb_up</i>Validate</button>
                                        <button  class="btn btn-danger btn-sm delete_all" data-url="{{ route('odindel') }}"><i class="material-icons">delete</i>Delete</button>
                                        <a href="{{ route('odins.create') }}" class="btn btn-sm btn-info">{{ __('Upload questions') }}</a>
                                        <a href="{{ route('oexport') }}" class="btn btn-sm btn-success">{{ __('Export to CSV') }}</a>
                            ...
                            <div class="table-responsive">
                                <table class="table" id="exampl">
                                        ...
                                        @foreach($odin  as $index =>$group)
                                            <tr id="tr_{{$group->id}}">
                                                ...
                                                <td class="td-actions text-right">
                                                    ...
                                                    <form action="{{ route('odins.destroy', $group) }}" method="post">
                                                        @csrf
                                                        @method('delete')
                                                        @can('edit_odins')
                                                            <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('odins.edit', $group) }}" data-original-title="" title="Edit">
                                    ...
                                    @else
                                        <td>
                                            <p>No odin created at the moment</p>
                                        </td>
                                    @endif
