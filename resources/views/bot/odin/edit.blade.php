...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" enctype="multipart/form-data" action="{{ route('odins.update',$odin) }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('put')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('question') ? ' has-danger' : '' }}">
                                                <input class="form-control{{ $errors->has('question') ? ' is-invalid' : '' }}"  name="question" id="input-que" type="text" placeholder="{{ __('Word') }}" value="{{ old('question',$odin->question) }}" required="true" aria-required="true"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('level') ? ' has-danger' : '' }}">
                                            ...
                                            {!! Form::select('level', array(1 => 'Elementary', 2 => 'Intermediate',3=>'Advanced'), $odin->level,['class' => 'form-control']); !!}
