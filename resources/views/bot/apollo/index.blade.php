                                            ...
                                            <tr id="tr_{{$group->id}}">
                                                ...
                                                <td class="td-actions text-right">
                                                    ...
                                                    <form action="{{ route('apollo.destroy', $group) }}" method="post">
                                                        ...
                                                        @can('edit_apollo')
                                                            <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('apollo.edit', $group) }}" data-original-title="">
                                                        ...
                                                        @can('delete_apollo')
                                                            ...
                                                            <button type="button" class="btn btn-danger btn-link" data-toggle="tooltip" rel="tooltip"  onclick="confirm('{{ __("Are you sure you want to delete this question?") }}') ? this.parentElement.submit() : ''">
                                                                <i class="material-icons">close</i>
                                                                <div class="ripple-container"></div>
                                                            </button>
                                                        @endcan
