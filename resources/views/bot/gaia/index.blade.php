                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title ">{{ $gaia->total() }} {{str_plural('Question',$gaia->count())}}</h4>
                            <p class="card-category"> {{ __('Here you can manage Gaia questions') }}</p>
                        </div>
                        <div class="card-body">
                            @if (session('status'))
                                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 text-right">
                                    @can('add_gaias')
                                        <button  class="btn btn-warning btn-sm validate_all" data-url="{{ route('gaiaval') }}"><i class="material-icons">thumb_up</i>Validate</button>
                                        <button  class="btn btn-danger btn-sm delete_all" data-url="{{ route('gaiadel') }}"><i class="material-icons">delete</i>Delete</button>
                                        <a href="{{ route('gaias.create') }}" class="btn btn-sm btn-info">{{ __('Upload questions') }}</a>
                                        <a href="{{ route('gexport') }}" class="btn btn-sm btn-success">{{ __('Export to CSV') }}</a>
...
{{--                                                </td>--}}
                                                <td class="td-actions text-right">
                                                    ...
                                                    <form action="{{ route('gaias.destroy', $group) }}" method="post">
                                                        @csrf
                                                        @method('delete')
                                                        @can('edit_gaias')
                                                            <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('gaias.edit', $group) }}" data-original-title="" title="Edit">
...
{{--                                                        @method('post')--}}
                                    ...
                                    @else
                                        <td>
                                            <p>No gaia created at the moment</p>
                                        </td>
                                    @endif
